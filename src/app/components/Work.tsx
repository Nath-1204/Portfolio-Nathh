...
const Work = () => {
  ...
  return (
    <div id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
        ...
        <div className='grid grid-cols-4 my-10 gap-5 text-black'>
            {workData.map((project, index)=>(
                ...
                <div key={index} className='aspect-square bg-no-repeat bg-cover bg-center rounded-lg relative cursor-pointer group' style={{backgroundImage: `url(${project.bgImage})`}}>
                    <div className='bg-white w-10/12 rounded-md absolute bottom-5 left-1/2 -translate-x-1/2 py-3 px-5 flex items-center justify-between duration-500 group-hover:bottom-9'>
                        <div>
        ...
        <a href="#work" className='w-max flex items-center justify-center gap-2 text-gray-700 border-[0.5px] border-gray-700 rounded-full y-3 px-10 mx-auto my-20 hover:bg-light  duration-500 '>
            Voir plus 
